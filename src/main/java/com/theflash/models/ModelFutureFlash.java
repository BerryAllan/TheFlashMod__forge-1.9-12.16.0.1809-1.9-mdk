package com.theflash.models;

import com.theflash.renderers.FlashRenderer;
import net.minecraft.client.model.ModelBiped;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class ModelFutureFlash extends ModelBiped
{
	...
	public ModelFutureFlash(float expand)
	{
...
/*
	public static class GlowArmor extends ModelBiped
	{
		...
		public void render(Entity entity, float par2, float par3, float par4, float par5, float par6, float par7)
		{
			...
			{
				this.isSneak = ((EntityLivingBase) entity).isSneaking();
				this.isRiding = ((EntityLivingBase) entity).isRiding();
